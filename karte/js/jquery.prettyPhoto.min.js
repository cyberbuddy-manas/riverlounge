  ...
  $.fn.prettyPhoto = function (pp_settings) {
    ...
    function _showContent() {
      ($(".pp_loaderIcon").hide(),
        (projectedTop =
          ...
          (windowHeight / 2 - pp_dimensions.containerHeight / 2)) < 0 &&
          (projectedTop = 0),
    ...
    function _getDimensions(width, height) {
      ((width = parseFloat(width)),
        ...
        ($pp_details = $pp_pic_holder.find(".pp_details")).width(width),
        (detailsHeight =
        ...
        $pp_details.remove(),
        ($pp_title = $pp_pic_holder.find(".ppt")).width(width),
        (titleHeight =
    ...
    function _center_overlay() {
      doresize &&
        ...
        (projectedTop =
          windowHeight / 2 + scroll_pos.scrollTop - contentHeight / 2) < 0 &&
          (projectedTop = 0),
    ...
    return (
      ...
      ($.prettyPhoto.initialize = function () {
        return (
          "pp_default" == (settings = pp_settings).theme &&
        ...
        return (
          ...
          $pp_pic_holder.fadeIn(function () {
            switch (
              ...
              case "vimeo":
                pp_dimensions = _fitToViewport(movie_width, movie_height);
                var match = (movie_id = pp_images[set_position]).match(
